...
from src.submittions.xgb_direct_mean_best import overall_pipeline \
    as xgb_direct_mean_pipeline
from src.submittions.xgb_direct_reduced_best import overall_pipeline \
    as xgb_direct_reduced_pipeline
from src.submittions.xgb_direct_sqrt_best import overall_pipeline \
...
DIRECT_MEAN_N_ESTS = 2#1076
DIRECT_SQRT_N_ESTS = 2#946
DIRECT_REDUCED_N_ESTS = 2#1195
